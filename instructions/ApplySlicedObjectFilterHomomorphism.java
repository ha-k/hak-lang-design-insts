...
public class ApplySlicedObjectFilterHomomorphism extends SlicingInstruction
{
  public ApplySlicedObjectFilterHomomorphism (int[][] slices)
    {
      setName("APPLY_SLICED_FHOM_O");
      _slices = slices;
    }
