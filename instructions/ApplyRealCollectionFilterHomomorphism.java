...
public class ApplyRealCollectionFilterHomomorphism extends ApplyCollectionHomomorphism
{
  public  ApplyRealCollectionFilterHomomorphism (Instruction tally)
    {
      super(tally);
      setName("APPLY_COLL_FHOM_R");
    }
