...
public class ApplyIntCollectionHomomorphism extends ApplyCollectionHomomorphism
{
  public  ApplyIntCollectionHomomorphism (Instruction tally)
    {
      super(tally);
      setName("APPLY_COLL_HOM_I");
    }
