...
public class ApplyObjectCollectionFilterHomomorphism extends ApplyCollectionHomomorphism
{
  public  ApplyObjectCollectionFilterHomomorphism (Instruction tally)
    {
      super(tally);
      setName("APPLY_COLL_FHOM_O");
    }
