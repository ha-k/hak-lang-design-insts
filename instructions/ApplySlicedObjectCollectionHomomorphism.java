...
public class ApplySlicedObjectCollectionHomomorphism extends ApplySlicedCollectionHomomorphism
{
  public ApplySlicedObjectCollectionHomomorphism (int[][] slices, Instruction tally)
    {
      super(slices,tally);
      _slices = slices;
    }
