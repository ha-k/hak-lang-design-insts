...
public class ApplySlicedInPlaceObjectCollectionFilterHomomorphism extends SlicingInstruction
{
  public ApplySlicedInPlaceObjectCollectionFilterHomomorphism (int[][] slices)
    {
      setName("APPLY_IP_COLL_SLICED_FHOM_O");
      _slices = slices;
    }
